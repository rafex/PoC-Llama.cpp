...
help:
	...
	@printf "\n$(CYAN)Modelos$(RESET)\n"
	@printf "  %-28s %s\n" "model-list"             "Lista el catálogo de modelos"
	@printf "  %-28s %s\n" "model-list-smart"       "Clasifica modelos según el hardware detectado"
	@printf "  %-28s %s\n" "model-list-smart-type"  "Filtra por tipo: TYPE=chat|coding|embedding|multimodal"
	@printf "  %-28s %s\n" "model-download-smart"   "Detecta hardware y descarga con menú inteligente"
	@printf "  %-28s %s\n" "model-download-smart-type" "Filtra por tipo: TYPE=chat|coding|..."
	@printf "  %-28s %s\n" "model-download"         "Menú interactivo simple de descarga"
	@printf "  %-28s %s\n" "model-download-id"      "Descarga por ID: ID=<id-del-modelo>"
	@printf "\n$(CYAN)Debug$(RESET)\n"
